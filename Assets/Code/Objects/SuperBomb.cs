...
public class SuperBomb : MonoBehaviour
{
    ...
    [SerializeField] private float bombTimer = 2;
    [SerializeField] private int explosionLength = 50;
    private bool exploded = false;
    private GameObject explosion;
    private Animator anim;
    public static int superbombCount = 0;
    public static int superbombsLeft = 3;
    ...
    void Explode()
    {
        ...
        CameraShake.Instance.Shake(6f, 0.3f);
        aS.Play();
